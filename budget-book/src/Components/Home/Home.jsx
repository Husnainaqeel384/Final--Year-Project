    ...
    return (
        ...
        <main
            ...
            <div className='flex flex-col sm:w-2/5  sm:justify-center sm:items-center' >
             ...
             sm:w-96 sm:p-8 sm:text-center sm:leading-tigh sm:-mt-8   rounded-3xl box-shadows
            '>
            ...
            '
                ...
                <Link to='/login' className='text-white  border font-bold  w-52 text-center ml-20 mt-8 p-2 rounded-lg hover:-translate-y-1 hover:scale-110 bg-indigo-500 duration-300 hover:text-white hover:font-bold hover:shadow-[0_4px_0px_rgb(0,0,0)] 
                sm:-ml-9
                '>
            ...
            <div className='flex justify-center items-center ml-5 w-84 mt-5  '>
                <img src={HomeImgae} alt="" className='' />
            </div>
        </main>
    </section>
    <Features />
