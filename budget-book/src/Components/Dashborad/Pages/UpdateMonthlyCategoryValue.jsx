...
const UpdateMonthlyCategoryValue = ({MonthlycategoryName , budgetDetailId,monthlyAmount,monthlyExpenseId}) => {
...
const handleSubmitClick = async () => {
        try {
            ...
            const { data } = await Axios.post(`${server}/updateMonthlyExpenseCategory/${monthlyExpenseId}/${budgetDetailId}`, {
                categoryName:MonthlycategoryName,
                Amount
            }, {
                headers: {
...
export default UpdateMonthlyCategoryValue