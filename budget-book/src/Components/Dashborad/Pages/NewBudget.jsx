            ...
            <div className='mt-16 md:mt-5 lg:mt-5'>
                ...
                <div className="mb-6 md:ml-10 lg:ml-10" >
                    <form onSubmit={submitbudget}>
                        ...
                        <div className='mt-5'>
                            <button type='submit' className="w-96 px-4 py-2 tracking-wide text-white transition-colors duration-200 transform bg-purple-700 rounded-md hover:bg-purple-600 focus:outline-none focus:bg-purple-600">
                                Create New Expense
                            </button>
                        </div>
                    </form>
